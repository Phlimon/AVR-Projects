...
#define LCD_SCROLL_TO_LEFT			0
#define LCD_SCROLL_TO_RIGHT			1
...
u8 LCD_u8StringScroll(u8 *Copy_u8String, u8 Copy_u8StrSize, u16 Copy_u16Time, u8 Copy_u8YPos, u8 Copy_u8RorL);
